...
grid search) to guard against overfitting on this small dataset. A hyperparameter-tuning sweep
found that reasoning backwards: `hidden_dim=256` (the *largest* size tested, tied with the
